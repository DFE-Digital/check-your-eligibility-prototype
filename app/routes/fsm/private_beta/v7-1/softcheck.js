module.exports = function(router) {
  ...
  router.post('/FSM/Private_beta/v7-1/family/start-now', (req, res) => {
      req.session.data.user = {};
      res.redirect('/FSM/Private_beta/v7-1/family/parent-soft-check/check');
  });
  ...
  router.post('/nass-number-answer', function (req, res) {
    ...
    if (nassNumber === "yes") {
      res.redirect('/FSM/Private_beta/v7-1/checker-parent/childs-age');
    } else {
      res.redirect('/FSM/Private_beta/v7-1/checker-parent/more-info-required-asylum');
    }
  });
