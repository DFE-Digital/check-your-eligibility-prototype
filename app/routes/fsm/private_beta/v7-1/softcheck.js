module.exports = function(router) {
    ...
    router.post('/family/start-now', (req, res) => {
        req.session.data.user = {};
        res.redirect('/v7-1/family/parent-soft-check/check');
    });
...
//v7-1//
   ...
   if (nassNumber == "yes"){
      ...
      res.redirect('/parent-soft-check/checking-loader')
    } else {
      // Send user to other page
     res.redirect('/parent-soft-check/nass-number')
   }
  })
