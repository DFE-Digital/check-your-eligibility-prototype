...
router.get('/fsm/private_beta/v7-3/test-johnson1', function (req, res) {
  res.send('Route works!');
});


router.post('/fsm/private_beta/v7-3/appeal-decision/johnson1', function (req, res) {
  const decision = req.session.data['decision'];

  if (decision === 'approve') {
    res.redirect('/fsm/private_beta/v7-3/LA/la-manage/decision/records/approve-johnson1');
  } else if (decision === 'decline') {
    res.redirect('/fsm/private_beta/v7-3/LA/la-manage/decision/records/decline-johnson1');
  } else if (decision === 'pending') {
    res.redirect('/fsm/private_beta/v7-3/LA/la-manage/decision/records/requestmore-johnson1');
  } else {
