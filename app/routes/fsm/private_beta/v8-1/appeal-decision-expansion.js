...
  router.post('/FSM/Private_beta/v8-1/appeal-decision/:childId', function (req, res) {
...
      return res.redirect(`/FSM/Private_beta/v8-1/LA/la-manage/decision/review/needs-review/approved/targeted/approve-targeted-${childId}`)
    }

    if (decision === 'approve-expanded') {
      return res.redirect(`/FSM/Private_beta/v8-1/LA/la-manage/decision/review/needs-review/approved/expanded/approve-expanded-${childId}`)
    }

    if (decision === 'decline') {
      return res.redirect(`/FSM/Private_beta/v8-1/LA/la-manage/decision/review/needs-review/declined/decline-${childId}`)
    }

    return res.redirect(`/FSM/Private_beta/v8-1/LA/la-manage/decision/review/needs-review/pending_${childId}`)
  })
}
