...
router.post('/fsm/private_beta/v8-1/appeal-decision/patel1', function (req, res) {
  const decision = req.session.data['decision-patel'];

  if (decision === 'approve-patel') {
    res.redirect('/fsm/private_beta/v8-1/mat/mat-manage/records/appeals/approve-patel1');
  } else if (decision === 'decline-patel') {
    res.redirect('/fsm/private_beta/v8-1/mat/mat-manage/records/appeals/decline-patel1');
  } else if (decision === 'pending-patel') {
    res.redirect('/fsm/private_beta/v8-1/mat/mat-manage/records/appeals/requestmore-patel1');
  } else {
    res.redirect('/fsm/private_beta/v8-1/appeal-decision');
  }
});
