module.exports = function (router) {
  ...
  //   if (niNumber === "yes") {
  //     if (enteredNiNumber) {
  //       res.redirect('/FSM/Private_beta/v7-2/LA/la-manage/la-soft-check/checking-loader');
  //     } else {
  //       res.redirect('/FSM/Private_beta/v7-2/LA/la-manage/la-soft-check/error-ni');
  //     }
  //   } else {
  //     res.redirect('/FSM/Private_beta/v7-2/LA/la-manage/la-soft-check/nass-number');
  //   }
  // });
