# FSM v8-2 Parent / Family User Journey Documentation

**Version:** v8-2  
**User Type:** Parent / Family  
**Journey:** Family i/ii route set  
**Scope:** Historical snapshot based on the files present under `app/views/FSM/Private_beta/v8-2` and `app/routes/fsm/private_beta/v8-2`.  
...
**Entry point:** /FSM/Private_beta/v8-2/family/start-now.html  
**Main route prefix:** `/v8-2`
...
|---|---|---|---|---|---|
| 1 | Landing page | /FSM/Private_beta/v8-2/family/start-now.html | User starts from the service home or dashboard | /FSM/Private_beta/v8-2/family/i/check.html | Entry point |
| 2 | Main check form | /FSM/Private_beta/v8-2/family/i/check.html | Enter parent or guardian details and choose the relevant option | Validation or loader | Submit form |
| 3 | Alternative branch or NASS guidance | /FSM/Private_beta/v8-2/family/i/nass-number.html | User chooses an asylum-seeker, NASS, or alternate support route | Follow-up page or result | Branch condition |
| 4 | Outcome or follow-up result | /FSM/Private_beta/v8-2/family/i/outcome-eligible.html | Review the outcome, eligibility status, or request for more evidence | Return path | Result branch |
| 5 | Exit | /FSM/Private_beta/v8-2/family/start-now.html | Return to dashboard or another management area | Dashboard | End of flow |
...
- `app/routes/fsm/private_beta/v8-2`
- `app/views/FSM/Private_beta/v8-2`
