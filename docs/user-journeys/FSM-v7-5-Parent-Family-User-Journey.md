# FSM v7-5 Parent / Family User Journey Documentation

**Version:** v7-5  
**User Type:** Parent / Family  
**Journey:** Parent soft check  
**Scope:** Historical snapshot based on the files present under `app/views/FSM/Private_beta/v7-5` and `app/routes/fsm/private_beta/v7-5`.  
...
**Entry point:** /FSM/Private_beta/v7-5/family/start-now.html  
**Main route prefix:** `/v7-5`
...
|---|---|---|---|---|---|
| 1 | Landing page | /FSM/Private_beta/v7-5/family/start-now.html | User starts from the service home or dashboard | /FSM/Private_beta/v7-5/family/parent-soft-check/check.html | Entry point |
| 2 | Main check form | /FSM/Private_beta/v7-5/family/parent-soft-check/check.html | Enter parent or guardian details and choose the relevant option | Validation or loader | Submit form |
| 3 | Alternative branch or NASS guidance | /FSM/Private_beta/v7-5/family/parent-soft-check/nass-number.html | User chooses an asylum-seeker, NASS, or alternate support route | Follow-up page or result | Branch condition |
| 4 | Outcome or follow-up result | /FSM/Private_beta/v7-5/family/parent-soft-check/outcome-not-entitled.html | Review the outcome, eligibility status, or request for more evidence | Return path | Result branch |
| 5 | Exit | /FSM/Private_beta/v7-5/family/start-now.html | Return to dashboard or another management area | Dashboard | End of flow |
...
- `app/routes/fsm/private_beta/v7-5`
- `app/views/FSM/Private_beta/v7-5`
